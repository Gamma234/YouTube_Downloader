...
def handle_stream_in_Download_From_a_Playlist( url, mgmt, main_mgmt, data ) :
...
def handle_caption_in_Download_From_a_Playlist( url, mgmt, main_mgmt, data ) :
...
def download_in_Download_From_a_Playlist( mgmt, main_mgmt, data ) :
        ...
        if running :
            ...
            for url in url_list :
                ...
                if mgmt['chk_val_dict']['only_caption'].get() == False :
                    strm_cond = handle_stream_in_Download_From_a_Playlist( url, mgmt, main_mgmt, data )
                cap_cond = handle_caption_in_Download_From_a_Playlist( url, mgmt, main_mgmt, data )                    
...
def see_info_in_Download_From_a_Playlist( mgmt, main_mgmt ) :
    ...
    try :
        url_list = ['None'] + YTDL.get_playlist_urls( mgmt['playlist_url_entry'].get() )
...
def check_ability_in_Download_From_a_Playlist( mgmt ) :
...
def Download_From_a_Playlist( main_frame, main_mgmt, main_conf ) :
    ...
    ret_mgmt['playlist_url_label'] = tk.Label( ret_mgmt['up_frame'], text='Playlist URL :' )
    ret_mgmt['playlist_url_label'].pack( side=tk.LEFT, padx=5 )

    ret_mgmt['playlist_url_strVar'] = tk.StringVar()

    ret_mgmt['playlist_url_entry'] = tk.Entry( ret_mgmt['up_frame'], width=75, textvariable=ret_mgmt['playlist_url_strVar'] )
    ...
    ret_mgmt['chk_val_dict']['filter_dict']['itag'].trace( 'w', lambda arg1, arg2, arg3 : 
                                                           check_ability_in_Download_From_a_Playlist( ret_mgmt ) ) ## monitor
    ...
    ret_mgmt['download_button'] = tk.Button( ret_mgmt['action_frame'], text='Download', bg='yellow',
                                             command=( lambda : download_in_Download_From_a_Playlist( ret_mgmt, main_mgmt, data ) ) )
    ...
    ret_mgmt['see_info_button'] = tk.Button( ret_mgmt['action_frame'], text='See Information',
                                             command=( lambda : see_info_in_Download_From_a_Playlist( ret_mgmt, main_mgmt ) ) )
    ret_mgmt['see_info_button'].pack( side=tk.RIGHT, padx=30 )
